...
const ProblemCrad = ({problem}) => {
  ...
  return (
    <div className='border-4 border-solid border-white hover:bg-blue-800 w-1/2 mb-5 rounded-md flex justify-between cursor-pointer  p-2 shadow-xl hover:shadow-2xl' onClick={handleClick}>
        <div className='flex'>
